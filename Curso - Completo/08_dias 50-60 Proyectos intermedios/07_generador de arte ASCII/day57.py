# Arte ASCII -> Se usan carateres especiales: @ # % * + = - : .
...
def map_pixels_to_ascii(img):
    ...
    ascii_str = "".join([ascii_chart[pixel // 25] for pixel in pixels])
    return ascii_str
...
def main():
    ...
    new_width = int(input("Enter the desired width of the ASCII art (default=100):"))
